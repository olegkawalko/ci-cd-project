...
[githubactions.yaml](.github/workflows) - default pipeline setup for important src/ files, include jobs:
...
3. delivery - builds and pushes docker image to docker hub
[github-dummy-action.yaml](.github/workflows) -
## Services i used:
